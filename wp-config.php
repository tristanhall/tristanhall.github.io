...
define('COOKIE_DOMAIN', 'tristanhall.com'); // Added by W3 Total Cache
...
define( 'AWS_ACCESS_KEY_ID', 'AKIAJXKZZA5HONDQMFFQ' );
define( 'AWS_SECRET_ACCESS_KEY', 'yDXyGGK7bm2Q+kSD0czIaIrtsP5kJlgTngc6wmUA' );

// ** MySQL settings - You can get this info from your web host ** //
/** The name of the database for WordPress */
define('DB_NAME', 'tristanhall');

/** MySQL database username */
define('DB_USER', 'tristanhall');

/** MySQL database password */
define('DB_PASSWORD', '2868thall');
