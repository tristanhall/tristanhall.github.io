...
class NoteController
{
    ...
    public static function action_admin_enqueue_scripts()
    {
        wp_register_script(
            'stashbox-note',
            plugins_url('stashbox/js/stashbox.note.js'),
            array('jquery', 'stashbox-core'),
            '1.0',
            true
        );
        ...
        wp_register_style(
            'stashbox-note',
            plugins_url('stashbox/css/stashbox.note.css'),
            array('dashicons')
        );
    ...
    public static function action_wp_ajax_stashbox_create_note()
    {
        ...
        if (is_numeric($comment_id)) {
            ...
            Note::load($comment);
            $comment_row = Template::make('notes/row-note', $comment, false);
            Template::makeJson(
                array(
                    'status'      => 'success',
