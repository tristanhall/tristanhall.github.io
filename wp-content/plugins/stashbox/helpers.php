...
if( !function_exists( 'stashbox_state_dropdown' ) ) {
   /**
...
if( !function_exists( 'stashbox_sanitize_array' ) ) {
   /**
    * Convert objects to arrays, return empty arrays for non-scalar variables and resources.
    * 
    * @access public
    * @param mixed $value
    * @return array
    */
   function stashbox_sanitize_array( $value ) {
      if( is_object( $value ) ) {
         return (array) $value;
      }
      if( !is_array( $value ) ) {
